...
public abstract class Folder {
     ...
     *
     * @param expunge If true all deleted messages will be expunged.
     * @param logout If true, sends a LOGOUT command to close the session.
     */
    public abstract void close(boolean expunge, boolean logout);
    ...
    public abstract Message[] logout() throws MessagingException;
    ...
    /**
     * Get Quota value from current Inbox
     * @return free Quota percentage for Inbox
     * @throws MessagingException 
     */
	public abstract int getQuotaRoot() throws MessagingException;
}
