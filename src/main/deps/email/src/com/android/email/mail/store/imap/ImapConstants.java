...
public final class ImapConstants {
    ...
    public static final String FETCH_FIELD_BODY_PEEK_SANE
            = String.format(Locale.getDefault(), "BODY.PEEK[]<0.%d>", Store.FETCH_BODY_SANE_SUGGESTED_SIZE);
    public static final String FETCH_FIELD_HEADERS =
            "BODY.PEEK[HEADER.FIELDS (date subject from content-type to cc message-id X-CNS-Greeting-Type)]";
    ...
    public static final String FLAG_GREETING_ON = "$CNS-Greeting-On";
