...
public class MimeMessage extends Message {
    ...
    @Override
    public String getGreetingType() throws MessagingException {
    	String greetingType = getFirstHeader(MimeHeader.GREETING_TYPE);
    ...
    @Override
    public void setGreetingType(String type) throws MessagingException {
    	setHeader(MimeHeader.GREETING_TYPE, type);
    }
