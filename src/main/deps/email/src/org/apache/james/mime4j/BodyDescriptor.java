...
public class BodyDescriptor {
    ...
    public void addField(String name, String value) {
        ...
        if (name.equals("content-transfer-encoding") && !contentTransferEncSet) {
            ...
            if (main != null) {
                main = main.toLowerCase(Locale.getDefault()).trim();
            ...
            if (c != null) {
                c = c.trim();
                if (c.length() > 0) {
                    charset = c.toLowerCase(Locale.getDefault());
                }
            }
                ...
                switch (state) {
                    ...
                    case IN_VALUE:
                        ...
                        switch (c) {
                            ...
                            case '\t':
                                result.put(
                                   paramName.toString().trim().toLowerCase(Locale.getDefault()),
    ...
    public boolean isMimeType(String mimeType) {
        return this.mimeType.equals(mimeType.toLowerCase(Locale.getDefault()));
    }
