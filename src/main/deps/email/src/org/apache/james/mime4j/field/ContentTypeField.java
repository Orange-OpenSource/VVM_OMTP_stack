...
public class ContentTypeField extends Field {
    ...
    public String getParameter(String name) {
        return parameters != null 
                    ? (String) parameters.get(name.toLowerCase(Locale.getDefault()))
                    : null;
    }
        ...
        public Field parse(final String name, final String body, final String raw) {
            ...
            try {
                ...
                if (type != null && subType != null) {
                    mimeType = (type + "/" + parser.getSubType()).toLowerCase(Locale.getDefault());
                    ...
                    if (paramNames != null && paramValues != null) {
                        for (int i = 0; i < paramNames.size() && i < paramValues.size(); i++) {
                            ...
                            String paramName = ((String)paramNames.get(i)).toLowerCase(Locale.getDefault());
