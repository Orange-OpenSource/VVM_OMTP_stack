...
public class Header {
    ...
    public void addField(Field field) {
        List values = (List) fieldMap.get(field.getName().toLowerCase(Locale.getDefault()));
        if (values == null) {
            values = new LinkedList();
            fieldMap.put(field.getName().toLowerCase(Locale.getDefault()), values);
        }
        values.add(field);
        fields.add(field);
    }
    ...
    public Field getField(String name) {
        List l = (List) fieldMap.get(name.toLowerCase(Locale.getDefault()));
        if (l != null && !l.isEmpty()) {
