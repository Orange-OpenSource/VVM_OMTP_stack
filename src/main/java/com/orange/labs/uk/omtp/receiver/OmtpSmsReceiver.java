...
public class OmtpSmsReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
    	// launch a dedicated service to handle the received SMS message
    	Intent smsReceiverService = new Intent(context, OmtpSmsReceiverHandler.class);
    	smsReceiverService.fillIn(intent, Intent.FILL_IN_DATA);
